...
class RankBasedEvaluator(Evaluator):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # self._ranks = {'head': defaultdict(list), 'tail': defaultdict(list)}
        if metrics is None:
            add_defaults = True
            metrics = []
    ...
    def process_scores_(
        ...
        # for i, (h, r, t) in enumerate(hrt_batch):
        #     self._ranks[target][str((h.item(), r.item(), t.item()))] = batch_ranks.realistic[i].item()
